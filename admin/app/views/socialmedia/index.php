    ...
    <div class="d-flex justify-content-between">
        ...
        <div class="col-sm-4 d-flex justify-content-end">
            <?php if( $data["permissions"]->can_create ) { ?>
                <a href="<?php echo _URL."socialmedia/insert"?>" class="btn btn-success btn-icon-split">
                        ...
                        <tr>
                            ...
                            <td><span class="text-nowrap"> <?php
                                    foreach ($data["statusArray"] as $status){
                                        if( $socialMedia->status_id == $status->id){
                            ...
                            <td class="text-nowrap">
                                ...
                                <a href="<?php echo _URL."socialmedia/insert/".helpers::encrypt($socialMedia->id)?>" class="btn-success btn-sm">Edit</a>
                                <!--                                    --><?php //} ?><!----><?php //if( $data["permissions"]->can_delete ) { ?>
                                <a href="#" class="btn-danger btn-sm" data-id="<?php echo helpers::encrypt($socialMedia->id) ?>" data-toggle="modal" data-target="#deleteModal">Eliminar</a>
                                <!--                                    --><?php //} ?>
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        <li class="page-item <?php echo ( $data["current"] == 1 )  ? "disabled" : "" ?>">
                            <a class="page-link" href="<?php echo _URL."socialmedia/".( $data["current"] - 1)?>" tabindex="-1" aria-disabled="true">Previous</a>
                        </li>
                        <?php
                        for( $i = 0 ; $i < $data["totalTabs"]; $i ++){ ?>
                            <li class="page-item <?php echo ( $data["current"] == $i+1) ? "active" : "" ?>">
                                <a class="page-link" href="<?php echo _URL."socialmedia/".( $i + 1)?>"><?php echo $i + 1;?></a>
                            </li>
                        <?php }
                        ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-danger" id="deleteAnchor" href="<?php echo _URL."socialmedia/delete/"?>">Eliminar</a>
            </div>
        </div>
    </div>
</div>