                ...
                <div class="col-lg-10 mx-auto">
                    <div class="p-5">
                        ...
                        <div class="card-body col-lg-10 mx-auto">
                            <form action="<?php echo _URL."testimonials/insert/".helpers::encrypt($data["id"]);?>" method="post">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="form-group row form-gr col-sm-12">
                                            ...
                                            <input required type="text" class="form-control col-sm-8" id="main_legend" name="url_image" aria-describedby="urlImageHelp" value="<?php echo $data["image_url"]?>" placeholder="/image.png">
                                            <!--                                <small id="mainLegendHelp" class="form-text text-muted">Legenda que aparece en la página principal.</small>-->
                                        </div>
                                        <div class="form-group row form-gr col-sm-12">
