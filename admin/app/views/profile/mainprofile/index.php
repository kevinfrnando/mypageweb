            ...
            <div class="card-body col-lg-12 mx-auto">
                <form action="<?php echo _URL."mainprofile/update";?>" method="post">
                    ...
                    <div class="row col-lg-12">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <div class="form-group row">
                                <label class="text-truncate col-lg-4 col-form-label">Email</label>
                                <input type="text" class="form-control col-lg-8 col-sm-12" id="email" name="email" value="<?php echo $data->email?>" placeholder="correo@dominio.com">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4">
                            <div class="form-group row">
                                <label class="text-truncate col-lg-4 col-form-label">Móvil</label>
                                <input type="text" class="form-control col-lg-8 col-sm-12" id="movil" name="movil" value="<?php echo $data->movil?>" placeholder="+XXX XXXX XXX XXX">
                            </div>
                        </div>
