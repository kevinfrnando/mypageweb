                ...
                <div class="col-lg-10 mx-auto">
                    <div class="p-5">
                        ...
                        <?php } else{ ?>
                            <div class="row alert alert-warning alert-dismissible fade show" role="alert">
                                <div>
                                    <strong>Error!</strong> No se pueden Crear Skils!
                                    <p><strong>Se deben Crear Primero SkillsType</strong> </p>
                                </div>

                            </div>
                            <div class="form-group row form-gr col-sm-12">
                                <a href="<?php echo _URL."skilltype/insert"?>" class="btn btn-success col-sm-12">
